 ...
 */
  ...
  + COUNT_ENABLED(PROBE_MANUALLY, BLTOUCH, BD_SENSOR, FIX_MOUNTED_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, SOLENOID_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, RACK_AND_PINION_PROBE, SENSORLESS_PROBING, MAGLEV4, MAG_MOUNTED_PROBE, STEPPER_RETRACTING_PROBE)
  #error "Please enable only one probe option: PROBE_MANUALLY, SENSORLESS_PROBING, BLTOUCH, BD_SENSOR, FIX_MOUNTED_PROBE, NOZZLE_AS_PROBE, TOUCH_MI_PROBE, SOLENOID_PROBE, Z_PROBE_ALLEN_KEY, Z_PROBE_SLED, MAGLEV4, MAG_MOUNTED_PROBE, STEPPER_RETRACTING_PROBE or Z Servo."
#endif
   ...
   */
    ...
    #endif
  #elif !HAS_Z_MIN_PROBE_PIN && DISABLED(HAS_ANALOG_PROBE)
...
#elif HAS_HOTEND && !ANY_PIN(TEMP_0, TEMP_0_CS)
...
#if HAS_MULTI_HOTEND && DISABLED(CHANTARELLE_SUPPORT)
 ...
 */
  ...
  #elif EXTRUDERS && TEMP_SENSOR_0 == 0 && DISABLED(CHANTARELLE_SUPPORT)
