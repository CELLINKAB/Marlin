...
#define BOARD_INFO_NAME "CELLINK_MYCORRHIZA_V1.0"
...
#define MSERIAL3_TX_PIN PC10
#define MSERIAL3_RX_PIN PC10

#define TMC_UART1 MSerial3

#define CUSTOM_MSERIAL5_PINS
#define MSERIAL5_TX_PIN PB12
#define MSERIAL5_RX_PIN PB12
...
#define PROBE_HARDWARE_SERIAL TMC_UART2
...
#define PRESSURE_REGULATOR_SENSE_PIN PF9
#define GRIPPER_VACUUM_PIN PF10 // PSENSE_1
#define PRESSURE_TANK_PIN PF8 // PSENSE_2

#define PRESSURE_PUMP_EN_PIN PE8

#define PRESSURE_VALVE_LID_PIN PF13 //V1
#define PRESSURE_VALVE_LID2_PIN PF14 //V2
#define PRESSURE_VALVE_PUMP_OUT_PIN PF15 //V3
