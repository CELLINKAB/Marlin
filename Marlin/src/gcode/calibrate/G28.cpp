...
#define BIND_HOMING_CURRENT(N) TERN_(HAS_HOMING_CURRENT(N), N##_HOMING_CURRENT = N##_CURRENT_HOME)

BIND_HOMING_CURRENT(X);
BIND_HOMING_CURRENT(Y);
BIND_HOMING_CURRENT(Z);
BIND_HOMING_CURRENT(X2);
BIND_HOMING_CURRENT(Y2);
BIND_HOMING_CURRENT(Z2);
