...
{
    static constexpr int32_t SRP_DEPLOY_VELOCITY = -50'000;
    static constexpr int32_t SRP_STOW_VELOCITY = 50'000;
    static constexpr uint8_t SRP_STALL_THRESHOLD = 120;
    static constexpr uint32_t SRP_STEPPER_CURRENT = 600;
    ...
    constexpr inline bool is_deployed() noexcept {return state == ProbeState::Deployed;}
