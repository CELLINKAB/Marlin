...
void reset_trinamic_drivers() {
  static constexpr bool stealthchop_by_axis[] = LOGICAL_AXIS_ARRAY(
    ...
    TERN_(X_SENSORLESS, stepperX.homing_current = X_CURRENT_HOME);
    TERN_(X2_SENSORLESS, stepperX2.homing_current = CAT(TERN(X2_SENSORLESS, X2, X), _CURRENT_HOME));
    TERN_(Y_SENSORLESS, stepperY.homing_current = Y_CURRENT_HOME);
    TERN_(Y2_SENSORLESS, stepperY2.homing_current = CAT(TERN(Y2_SENSORLESS, Y2, Y), _CURRENT_HOME));
    TERN_(Z_SENSORLESS, stepperZ.homing_current = Z_CURRENT_HOME);
    TERN_(Z2_SENSORLESS, stepperZ2.homing_current = CAT(TERN(Z2_SENSORLESS, Z2, Z), _CURRENT_HOME));
    TERN_(Z3_SENSORLESS, stepperZ3.homing_current = CAT(TERN(Z3_SENSORLESS, Z3, Z), _CURRENT_HOME));
    TERN_(Z4_SENSORLESS, stepperZ4.homing_current = CAT(TERN(Z4_SENSORLESS, Z4, Z), _CURRENT_HOME));
    TERN_(I_SENSORLESS, stepperI.homing_current = I_CURRENT_HOME);
    TERN_(J_SENSORLESS, stepperJ.homing_current = J_CURRENT_HOME);
    TERN_(K_SENSORLESS, stepperK.homing_current = K_CURRENT_HOME);
    TERN_(U_SENSORLESS, stepperU.homing_current = U_CURRENT_HOME);
    TERN_(V_SENSORLESS, stepperV.homing_current = V_CURRENT_HOME);
    TERN_(W_SENSORLESS, stepperW.homing_current = W_CURRENT_HOME);
    TERN_(E0_SENSORLESS, stepperE0.homing_current = E0_CURRENT_HOME);
    TERN_(E1_SENSORLESS, stepperE1.homing_current = E1_CURRENT_HOME);
    TERN_(E2_SENSORLESS, stepperE2.homing_current = E2_CURRENT_HOME);
    TERN_(E3_SENSORLESS, stepperE3.homing_current = E3_CURRENT_HOME);
    TERN_(E4_SENSORLESS, stepperE4.homing_current = E4_CURRENT_HOME);
    TERN_(E5_SENSORLESS, stepperE5.homing_current = E5_CURRENT_HOME);
    TERN_(E6_SENSORLESS, stepperE6.homing_current = E6_CURRENT_HOME);
    TERN_(E7_SENSORLESS, stepperE7.homing_current = E7_CURRENT_HOME);
  #endif
