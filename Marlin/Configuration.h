 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   Z_MAX_POS // Z Clearance for Deploy/Stow
#define Z_CLEARANCE_BETWEEN_PROBES Z_MAX_POS // Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE    10 // Z Clearance between multiple probes
#define Z_AFTER_PROBING           Z_MAX_POS // Z position after probing is done
